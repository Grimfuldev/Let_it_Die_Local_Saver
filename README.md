...
The point of this program is to be the least invasive possible so you can forget about saving backups or managing settings. Everything is automatic and only on background after it’s configured. It works like an offline cloud backup that manages itself.
